            ...
            <CardActionArea>
                ...
                <CardContent>
                    ...
                    <Typography variant="body2" color="textSecondary" component="p">
                        {isEdit ? <input value={data.discription} onChange={(e) => setData({ ...data, discription: e.target.value })}></input> : 
                        <div className={classes.DiscItem}>{data.discription}</div>}
                    </Typography>
                </CardContent>
            </CardActionArea>
            ...
            <CardActions>
                {isEdit ?
                    ...
                    <>
                        ...
                        <Button size="small" style={{ background: 'rgb(200,50,50)' }} onClick={() => props.crud[0](data.id)}>DELETE</Button>
                    </>
                }
